...
export const setCookies = (res, accessToken, refreshToken) => {
  ...
  if (isProduction) {
    ...
    // The storefront (mwpsupplements.com) and the API (api.mwpsupplements.com) are different
    ...
    if (process.env.COOKIE_DOMAIN) {
      // e.g. COOKIE_DOMAIN=.mwpsupplements.com so the cookie is shared across subdomains.
