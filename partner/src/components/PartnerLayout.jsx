    ...
    return (
      ...
      `}>
                <div className="flex flex-col h-full">
                    {/* Logo */}
                    <div className="flex items-center justify-between h-16 px-5 border-b border-orange-400/40">
                        <div className="flex items-center space-x-2.5">
                            <img src="/logo.png" alt="MWP" className="h-8 w-auto object-contain rounded" />
                            <div>
                                <h1 className="text-sm font-black text-white tracking-wider">MWP PARTNER</h1>
                                <p className="text-[10px] text-orange-100 uppercase tracking-widest font-bold">Athlete Portal</p>
                            </div>
                        </div>
                        <Button
                            variant="ghost"
