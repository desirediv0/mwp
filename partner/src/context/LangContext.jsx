...
const translations = {
    en: {
        ...
        dashboard_subtitle: "Here's an overview of your partnership performance with MWP Supplements.",
    ...
    hi: {
        ...
        dashboard_subtitle: 'MWP Supplements के साथ आपकी पार्टनरशिप का सारांश',
