...
const translations = {
  hero_badge: "Join Our Partner & Athlete Affiliate Network",
  hero_title: "Become an MWP Partner & Athlete Affiliate",
  hero_subtitle:
    "Partner with India's elite sports nutrition & wellness brand. Gyms, fitness trainers, athletes, and retail partners — let's grow together.",
  btn_apply: "Join the Team",
  btn_login: "Partner Login",
  benefits_title: "Why Partner with MWP SUPPLEMENTS?",
  b1_title: "Direct Lab Supply",
  b1_desc: "Access fresh, verified batches with top distributor margins and expedited dispatch.",
  b2_title: "Live Partner Dashboard",
  b2_desc: "Real-time tracking of orders, coupon performance, and commission payouts.",
  b3_title: "Marketing & Athlete Support",
  b3_desc: "Get premium marketing materials, product samples, and co-branded digital collateral.",
  b4_title: "Clean Formulations",
  b4_desc: "100% label transparency, third-party lab tested, and zero banned substances.",
  ...
  form_city: "City",
  form_state: "State",
  form_message: "Tell us about your fitness business, gym, or athlete profile",
  form_submit: "Submit Application",
  form_submitting: "Submitting...",
  success_title: "Application Received!",
  success_msg:
    "Thank you for your interest in MWP SUPPLEMENTS. Our partnership team will reach out within 48 hours.",
  ...
  note: "By submitting, you agree to our partnership & affiliate terms.",
};
