...
export const metadata = {
    title: "Return Policy | MWP Supplements",
                ...
                <div className="section-container max-w-4xl">
                    ...
                    <div className="prose prose-lg max-w-none">
                        ...
                        <ol className="space-y-3 mb-8 list-decimal list-inside">
                            <li><strong>Contact Support:</strong> Email us at support@mwpsupplements.com </li>
                        ...
                        <ul className="space-y-2">
                            <li>Email: <strong>support@mwpsupplements.com</strong></li>
