...
export default function NonApprovedPartnersTab() {
    ...
    const [customPassword, setCustomPassword] = useState("mwpsupplements");
    ...
    const openApproveDialog = (id: string) => {
        setApproveId(id);
        setApproveApiError("");
        setCustomPassword("mwpsupplements");
    ...
    const handleApprove = async () => {
        const passwordToSend = customPassword.trim().length >= 6 ? customPassword.trim() : "mwpsupplements";
                ...
                <DialogContent>
                    ...
                    <div className="rounded-xl border border-green-200 bg-green-50 p-4 space-y-3">
                        ...
                        <div className="text-xs text-green-700 space-y-0.5">
                            <p>Partner dashboard: <strong>partner.mwpsupplements.com</strong></p>
